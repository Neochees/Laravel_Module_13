...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <a href="/">
                    <img src="{{url('/assets/images')}}/logo.svg" alt="Laracasts Logo" width="165" height="16">
                </a>
            </div>
        ...
        <header class="max-w-xl mx-auto mt-20 text-center">
            ...
            <h2 class="inline-flex mt-2">By Lary Laracore <img src="{{url('/assets/images')}}/lary-head.svg" alt="Head of Lary the mascot"></h2>
        ...
        <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6">
            <article class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
                <div class="py-6 px-5 lg:flex">
                    <div class="flex-1 lg:mr-8">
                        <img src="{{url('/assets/images')}}/illustration-1.png" alt="Blog Post illustration" class="rounded-xl">
                    </div>
                    ...
                    <div class="flex-1 flex flex-col justify-between">
                        ...
                        <footer class="flex justify-between items-center mt-8">
                            <div class="flex items-center text-sm">
                                <img src="{{url('/assets/images')}}/lary-avatar.svg" alt="Lary avatar">
                                <div class="ml-3">
            ...
            <div class="lg:grid lg:grid-cols-2">
                ...
                <article class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
                    <div class="py-6 px-5">
                        <div>
                            <img src="{{url('/assets/images')}}/illustration-2.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
            ...
            <div class="lg:grid lg:grid-cols-3">
                <article class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
                    <div class="py-6 px-5">
                        <div>
                            <img src="{{url('/assets/images')}}/illustration-3.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
                ...
                <article class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
                    <div class="py-6 px-5">
                        <div>
                            <img src="{{url('/assets/images')}}/illustration-4.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
                ...
                <article class="transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
                    <div class="py-6 px-5">
                        <div>
                            <img src="{{url('/assets/images')}}/illustration-5.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
        ...
        <footer class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            <img src="{{url('/assets/images')}}/lary-newsletter-icon.svg" alt="" class="mx-auto -mb-6" style="width: 145px;">
                    ...
                    <form method="POST" action="#" class="lg:flex text-sm">
                        <div class="lg:py-3 lg:px-5 flex items-center">
                            <label for="email" class="hidden lg:inline-block">
                                <img src="{{url('/assets/images')}}/mailbox-icon.svg" alt="mailbox letter">
                            </label>
